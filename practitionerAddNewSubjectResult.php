...
<head>
    <title>Insert subject result - Practitioner</title>
    <link rel="stylesheet" type="text/css" href="css/main.css">
    <link rel="stylesheet" type="text/css" href="css/practitionerAddNewSubjectResult.css">
        ...
        <?php
            ...
            echo "<div id=\"twoColContent\">";
                ...
                if(isset($_SESSION['username'])) {
                    ...
                    //create query to insert into PractitionerWithSubject table
                    $insertQuery = "INSERT INTO PractitionerWithSub (PractitionerID, SubjectID) VALUES ('$currentPractitionerID', '$subjectID');";
                    $insertQueryResult = odbc_exec($conn, $insertQuery);
