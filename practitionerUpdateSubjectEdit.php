...
<head>
    ...
    <title>Edit subject - Practitioner</title>
    <link rel="stylesheet" type="text/css" href="css/main.css">
    <link rel="stylesheet" type="text/css" href="css/practitionerUpdateSubjectEdit.css">
        ...
        <?php
            ...
            echo "<div id=\"twoColContent\">";
                ...
                if(isset($_SESSION['username'])) {
                    ...
                    echo "<form method=\"post\" id=\"updateForm\" onSubmit=\"return validateForm()\" action=\"practitionerEditSubjectResult.php\">";
                    echo "<table>";
