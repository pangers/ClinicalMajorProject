...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/administratorSearchSubject.css">
        ...
        <?php
            ...
            echo "<div id=\"twoColContent\">";
                ...
                if(isset($_SESSION['username'])) {
                    ...
                    echo "<form method=\"post\" id=\"searchForm\" onSubmit=\"return validateSearchForm()\" action=\"administratorSearchSubjectResult.php\">";
                    echo "<table>";
