...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/assignSubToPractitioner.css">
        ...
        <?php
            ...
            echo "<div id=\"twoColContent\">";
                ...
                if(isset($_SESSION['username'])) {
                    ...
                    echo "<p>Select a practitioner to assign subjects to and click assign.</p>";
                    ...
                    echo "<form method=\"post\" id=\"\" action=\"assignSubToPractitionerCheckBoxes.php\">";
