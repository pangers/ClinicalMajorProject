...
<head>
    ...
    <title>Add a new test trial - Admin</title>
    <link rel="stylesheet" type="text/css" href="css/main.css">
    <link rel="stylesheet" type="text/css" href="css/addTestTrialForm.css">
        ...
        <?php
            ...
            echo "<div id=\"twoColContent\">";
                ...
                if(isset($_SESSION['username'])) {
                    ...
                    echo "<form method=\"post\" id=\"trialForm\" onSubmit=\"return validateTestTrialForm()\" action=\"addTestTrialResult.php\">";
                    echo "<table>";
