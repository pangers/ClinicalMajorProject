...
<head>
    ...
    <title>Add a new subject - Admin</title>
    <link rel="stylesheet" type="text/css" href="css/main.css">
    <link rel="stylesheet" type="text/css" href="css/addNewSubject.css">
    ...
    <?php
        ...
        echo "<div id=\"twoColContent\">";
            ...
            if(isset($_SESSION['username'])) {
                ...
                echo "<form method=\"post\" id=\"addForm\" onSubmit=\"return validateForm()\" action=\"addNewSubjectResult.php\">";
                echo "<table>";
