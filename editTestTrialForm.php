...
<head>
    ...
    <title>Edit trial test - Admin</title>
    <link rel="stylesheet" type="text/css" href="css/main.css">
    <link rel="stylesheet" type="text/css" href="css/editTestTrialForm.css">
        ...
        <?php
            ...
            echo "<div id=\"twoColContent\">";
                ...
                if(isset($_SESSION['username'])) {
                    ...
                    echo "<form method=\"post\" id=\"updateForm\" onSubmit=\"return validateForm()\" action=\"editTestTrialResult.php\">";
                    echo "<table>";
